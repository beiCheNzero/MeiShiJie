...
<head>
  ...
  <link rel="stylesheet" href="../style/css/menu_video.css">
...
<body>
  ...
  <div class="nav">
    <div class="nav_ul">
      ...
      <li><a href="menu_video.php" class="a"><strong class="cli layui-anim layui-anim-rotate">菜谱视频</strong></a></li>
  ...
  <div class="content">
    <div class="main_w">
      <div class="v_path">
        <a href="/">美食杰首页</a><span> &gt; </span><span>视频菜谱</span>
      </div>
      ...
      <div class="v_list" id="v_list">
        <div class="v_item">
          <a href="">
            <video src="../video/video_1.mp4" controls="controls" poster="../img/video/poster_1.jpg"></video>
            <div class="c2">
              <strong class="v_name">左宗棠鸡的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_2.mp4" controls="controls" poster="../img/video/poster_2.jpg"></video>
            <div class="c2">
              <strong class="v_name">紫薯药糕的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_3.mp4" controls="controls" poster="../img/video/poster_3.jpg"></video>
            <div class="c2">
              <strong class="v_name">猪油拌饭的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_4.mp4" controls="controls" poster="../img/video/poster_4.jpg"></video>
            <div class="c2">
              <strong class="v_name">猪血汤的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_5.mp4" controls="controls" poster="../img/video/poster_5.jpg"></video>
            <div class="c2">
              <strong class="v_name">猪心汤的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_6.mp4" controls="controls" poster="../img/video/poster_6.jpg"></video>
            <div class="c2">
              <strong class="v_name">猪皮冻的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_7.mp4" controls="controls" poster="../img/video/poster_7.jpg"></video>
            <div class="c2">
              <strong class="v_name">猪肝粥的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_8.mp4" controls="controls" poster="../img/video/poster_8.jpg"></video>
            <div class="c2">
              <strong class="v_name">猪肝面的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_9.mp4" controls="controls" poster="../img/video/poster_9.jpg"></video>
            <div class="c2">
              <strong class="v_name">珍珠翡翠白玉汤的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_10.mp4" controls="controls" poster="../img/video/poster_10.jpg"></video>
            <div class="c2">
              <strong class="v_name">蒸肉丸的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_11.mp4" controls="controls" poster="../img/video/poster_11.jpg"></video>
            <div class="c2">
              <strong class="v_name">炸鱼薯条的做法</strong>
            </div>
          </a>
        </div>
        <div class="v_item">
          <a href="">
            <video src="../video/video_12.mp4" controls="controls" poster="../img/video/potter_12.jpg"></video>
            <div class="c2">
              <strong class="v_name">炸鱼块的做法</strong>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="listtyle1_page">
        <div class="listtyle1_page_w">
          <a title="的做法大全第1页" href="" class="current">1</a>
          <a title="的做法大全第2页" href="">2</a>
          <a title="的做法大全第3页" href="">3</a>
          <a title="的做法大全第4页" href="">4</a>
          <a title="的做法大全第5页" href="">5</a>
